...
I included svelte-hero-icon to have a library of icons in the template. There is currently a Svelte error about invalid declaration of {Icon, Sun, Moon} in Header - this is annoying but can be ignored. Not sure how to get around it atm without disabling the overlay completely.